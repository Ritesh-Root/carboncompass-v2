...
export interface CarbonResult {
  ...
  device_id: string;
  // Lifestyle context echoed from the input so insight generation can
  // personalise to the user's actual diet, shopping, and flight habits.
  diet_type: 'meat_heavy' | 'meat_medium' | 'vegetarian' | 'vegan';
  consumption_level: 'high' | 'medium' | 'low';
  flights_short_haul: number;
  flights_long_haul: number;
...
export type InsightCategory = 'transport' | 'home' | 'diet' | 'consumption' | 'general';
