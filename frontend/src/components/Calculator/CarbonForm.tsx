...
const InputField = ({
  ...
  return (
    <div className="space-y-1">
      ...
      {error && (
        <span id={errorId} role="alert" aria-live="polite" className="text-xs text-red-600">
          {error}
        </span>
      )}
    </div>
    ...
    >
        ...
        <div className="space-y-6">
              ...
              {(
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">
                    {label}
                    <span className="block text-xs font-normal text-gray-500">{desc}</span>
                  </span>
                </label>
              ))}
            </div>
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="
                w-full sm:w-72 rounded-lg border border-gray-300 px-3 py-2 text-sm
                focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500
            ...
            >
              ...
              <option value="medium">Medium — average consumer spending</option>
      ...
      {storeError && (
        ...
        >
          ...
          <p className="text-sm text-red-600 mt-0.5">{storeError}</p>
        </div>
      )}
      ...
      <div className="flex justify-center pt-2">
        <button
          ...
          className="
            inline-flex items-center justify-center gap-2 bg-primary-600 text-white
